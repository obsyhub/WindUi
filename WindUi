...
local a a={cache={}, load=function(b)if not a.cache[b]then a.cache[b]={c=a[b]()}end return a.cache[b].c end}do function a.a()local b=cloneref(game:GetService"RunService")local d=
b.Heartbeat
...
local j=loadstring(game:HttpGet(i))()
...
local aq=game.Players.LocalPlayer:WaitForChild"PlayerGui"
